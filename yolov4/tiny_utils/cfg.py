...
Cfg.cfgfile = os.path.join('cfg', 'yolov4-tiny.cfg')
Cfg.is_tiny = True
Cfg.pretrained = '../weights/yolov4-tiny.conv.29'
...
Cfg.train_label = os.path.join('data', 'train.txt')
Cfg.val_label = os.path.join('data' ,'val.txt')
