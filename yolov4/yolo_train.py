...
from losses.yolov4_loss import Yolo_loss
...
def train(model, device, config, epochs=5, batch_size=1, num_workers=1, save_cp=True, log_step=20, img_scale=0.5):
    ...
    train_loader = DataLoader(train_dataset, batch_size=config.batch // config.subdivisions, shuffle=True, num_workers=num_workers, pin_memory=True, drop_last=True, collate_fn=collate)
